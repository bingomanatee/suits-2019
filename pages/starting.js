import HeadView from "../views/PageHead";
  ...
  return <div>
    ...
    <main>
      <article>
       ...
       <h2>Example 1: localized State in a login form</h2>
      ...
      <p>for a login form, the state can be encapsulated in the component; since there is no need to share state
        ...
        <p>Along with the username/password fields, we can aadd a host of utility such as a status message for each field
          and a flag to disable login with invalid value. Normallw we'd submit to an API end point, ut in this case
